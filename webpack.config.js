...
module.exports = {
    ...
    entry: {
        ...
        app: path.join(__dirname, 'app/static/vendor/vue/main.js'),   // 절대경로로 주기위해 path.join 사용
    },
    module: {
        rules: [
            {   // webpack은 javascripts만 처리. javascripts 외 다른 파일을 읽을 수 있도록 rules를 추가함
    ...
    output: {
        ...
        path: path.join(__dirname, 'app/static/vendor/vue/dist'),  // 절대경로로 주기위함
        publicPath: '/dist'
    },
};